...
class FixedControl : public ControlInterface {
   public:
    FixedControl(ActuatorConfig &engine, ActuatorConfig &left_aileron,
                 ActuatorConfig &right_aileron, ActuatorConfig &rudder, ActuatorConfig &elevator)
        : ControlInterface(NumActuatorIdx),
          configs{engine, left_aileron, right_aileron, rudder, elevator} {};

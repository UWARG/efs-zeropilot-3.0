...
{
    WaypointData stoppingPoint; //contains the path data to the stopping point, which is at the end of the landing when the plane comes to a stop
    WaypointData aimingPoint; //contains the path data to the aiming point, which is where the slope of the aircraft meets the surface of the ground
    WaypointData intersectionPoint; //contains the path data to the intersection point, which is where the slope of the aircraft intersects with the current altitude of the aircraft
};
...
class LandingTakeoffManager{
    ...
    public:
        ...
        /*
            ...
            @param WaypointData * aimingPoint - this variable will hold the location of the aiming point
            @param WaypointData * intersectionPoint - this variable will hold the location of the intersectionPoint
            @param WaypointData * stoppingPoint - this variable will hold the location of the stoppingPoint

            @return double - this function will return the desiredAltitude for the position of the relative points
        */
        static double changingAltitude(const SFOutput_t & input, const WaypointData & aimingPoint, const WaypointData & intersectionPoint, const WaypointData & stoppingPoint);
        ...
        */
        static WaypointData createTakeoffWaypoint(double currentLatitude, double currentLongitude, float currentAltitude, float takeoffDirection);

...
double LandingTakeoffManager::changingAltitude(const SFOutput_t & input, const WaypointData & aimingPoint, const WaypointData & intersectionPoint, const WaypointData & stoppingPoint)
{
    //vector declaration
...
WaypointData LandingTakeoffManager::createTakeoffWaypoint(double currentLatitude, double currentLongitude, float currentAltitude, float takeoffDirection)
{
    WaypointData desiredWaypoint;
